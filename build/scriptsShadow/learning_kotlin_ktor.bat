...
set CLASSPATH=%APP_HOME%\lib\learning_kotlin_ktor-all.jar

@rem Execute learning_kotlin_ktor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LEARNING_KOTLIN_KTOR_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%LEARNING_KOTLIN_KTOR_EXIT_CONSOLE%" exit 1
exit /b 1
